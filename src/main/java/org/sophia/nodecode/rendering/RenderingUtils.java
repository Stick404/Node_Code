...
public class RenderingUtils {
    ...
    public static void makeDoubleSideSquare(BufferBuilder buff, Matrix4f view, int color, PoseStack stack){
        ...
        buff.addVertex(view, 1f,0f,0f).setUv(1f,0f).setLight(16).setColor(color).setUv2(0,1).setNormal(1f,1f,0f);
        buff.addVertex(view, 1f,1f,0f).setUv(1f,1f).setLight(16).setColor(color).setUv2(1,1).setNormal(1f,1f,0f);
        buff.addVertex(view, 0f,1f,0f).setUv(0f,1f).setLight(16).setColor(color).setUv2(1,0).setNormal(0f,1f,0f);
        buff.addVertex(view, 0f,0f,0f).setUv(0f,0f).setLight(16).setColor(color).setUv2(0,0).setNormal(0f,0f,0f);
